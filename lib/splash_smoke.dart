...
/// ### Assertions:
///
/// - Either `nextPage` or `conditionalNavigations` must be provided. If neither
...
class SplashSmoke extends StatefulWidget {
  ...
  final ConditionalNavigations? conditionalNavigation;
  final Widget child;
  SplashSmoke({
    super.key,
...
/// A `StatefulWidget` that represents the starting screen of the application.
///
/// This widget takes a required [SplashSmoke] instance as a parameter, which
/// is passed to the `widget` property. It is used to initialize the state
/// and manage the behavior of the starting screen.
