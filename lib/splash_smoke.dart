    ...
    var manualSequence = AnimationSequence(
      sequences: [
        ...
        [
          ...
          CircleData(id: '8', normalizedPosition: const Offset(1, .40), radius: 20, color: isDev ? Colors.indigo : splashSmoke.effectColor), //Color.fromRGBO(176, 176, 176, 1)),
        ],
        [
          CircleData(
            id: '1',
